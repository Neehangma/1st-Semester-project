...
#Label in inner right frame:

std_detail_lbl = CTkLabel(std_mp_fr4,text="Student's Details :",text_color="#FFFFFF",fg_color="#0F56A2",font=("Times New Roman",25,'bold'))
std_detail_lbl.place(x=165,y=35)


std_student_name_lbl = CTkLabel(std_mp_fr4,text="Student Name :",text_color="#FFFFFF",fg_color="#0F56A2",font=("Times New Roman",20))
std_student_name_lbl.place(x=55,y=100)

std_Date_of_birth_lbl = CTkLabel(std_mp_fr4,text="Date Of Birth :",text_color="#FFFFFF",fg_color="#0F56A2",font=("Times New Roman",20))
std_Date_of_birth_lbl.place(x=55,y=165)

std_Gender_lbl = CTkLabel(std_mp_fr4,text="Gender :",text_color="#FFFFFF",fg_color="#0F56A2",font=("Times New Roman",20))
std_Gender_lbl.place(x=55,y=230)

std_Email_lbl = CTkLabel(std_mp_fr4,text="Email :",text_color="#FFFFFF",fg_color="#0F56A2",font=("Times New Roman",20))
std_Email_lbl.place(x=55,y=295)

std_Phone_number_lbl = CTkLabel(std_mp_fr4,text="Phone Number :",text_color="#FFFFFF",fg_color="#0F56A2",font=("Times New Roman",20))
std_Phone_number_lbl.place(x=55,y=360)


std_Guardians_name_lbl = CTkLabel(std_mp_fr4,text="Guardian's Name :",text_color="#FFFFFF",fg_color="#0F56A2",font=("Times New Roman",20))
std_Guardians_name_lbl.place(x=55,y=425)

std_address_lbl = CTkLabel(std_mp_fr4,text="Address :",text_color="#FFFFFF",fg_color="#0F56A2",font=("Times New Roman",20))
std_address_lbl.place(x=55,y=490)
